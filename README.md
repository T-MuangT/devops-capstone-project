...
![Build Status](https://github.com/T-MuangT/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)


=======
This repository utilizes the starter code for the project in [**IBM-CD0285EN-SkillsNetwork DevOps Capstone Project**](https://www.coursera.org/learn/devops-capstone-project?specialization=devops-and-software-engineering) which is part of the [**IBM DevOps and Software Engineering Professional Certificate**](https://www.coursera.org/professional-certificates/devops-and-software-engineering)

## Usage

This repository came from the template provided by IBM's DevOps Capstone Project template. The details of usages are as follows below.
